...
public class EmployeeServiceImpl implements EmployeeService {
	...
	public String removeEmpDetails(Long empId) {
		Employee employee = empRepo.findById(empId) // rets empty Optional in case of 
				//invalid emp id n rets populated
													// emp holder in case of success
	...
	public SigninResponse authenticate(SigninRequest request) {
		...
		//emp : src object (entity) , SigninResponse.class : dest class type
		//entity ---> dto
