 ...
 *
 */
@WebListener //Mandatory cls level annotation to tell WC : following is the event listener class
public class DemoListener implements ServletContextListener, HttpSessionListener, ServletRequestListener {
