...
public class ProcessAdmissionForm extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try (PrintWriter pw = response.getWriter()) {
			...
			/*
			 * WC suspends doPost of 1st page -- WC continues with the resp buffer(PW's
			 * buffer) WC invokes doPost method of the result page
			 */
			System.out.println("control came back .....");// appears on server side console
			pw.print("<h4>contents after include....</h4>");
		} // pw.close
