...
1. import  --- comma separated list of pkgs or packaged classes.
...
In formal words --- Java bean properties reflect the conversational state of the clnt.
...
Can be ONLY used as the nested tag within : <jsp:forward> OR <jsp:include>
To add additional req param.
...
URL in case of no cookies : http://host:port/day7/two.jsp;jsessionid=fdghsdf57356756
URL in case of cookies : http://host:port/day7/two.jsp
...
B.L method : public List<Category> listCategories()
...
WC --- response.sendRedirect(response.encodeRedirectURL(session.getAttribute("my_bank").closeAccount()));
