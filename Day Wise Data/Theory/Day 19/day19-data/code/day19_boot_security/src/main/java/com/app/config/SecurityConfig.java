...
public class SecurityConfig {
	...
	//method to declare a spring bean , to configure user details
	//Ret type : UserDetailsService : main i/f to store user details
	//will be used for authentication + authorization purpose
	@Bean
